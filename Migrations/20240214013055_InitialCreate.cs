    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "rockem@gmail.com", "Donna", "Tartt" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://tse1.mm.bing.net/th?id=OIP.AWhxrxDaLYVVIF_ebbSSIwHaFj&pid=Api&P=0&h=220", "Otter Oasis" },
                    { 3, 3, "https://tse1.mm.bing.net/th?id=OIP.sHb_YYkhthQJJwy5wrUSPgHaFj&pid=Api&P=0&h=220", "The Dugout" },
                    { 4, 4, "https://tse1.mm.bing.net/th?id=OIP.Sm_BpCWYOC7l7rS25yo85AHaE8&pid=Api&P=0&h=220", "The Hammock District" },
                    { 5, 1, "https://tse2.mm.bing.net/th?id=OIP.xZcbHkbImK2Ahx0FOkOnrAHaDt&pid=Api&P=0&h=220", "Raccoon's Rest" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 5, new DateTime(2023, 10, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });
